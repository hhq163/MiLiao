/*
 * 这里包含数据库操作类，数据库连接类，连接池管理类
 *
 *  Created on: 2016年5月25日
 *      Author: hhq163
 */

#ifndef SRC_HTTP_SVR_DBPOOL_H_
#define SRC_HTTP_SVR_DBPOOL_H_
...
public:
	...
	static CDBManager* getInstance(CConfigFileReader* configFile);
...
private:
	...
	static CConfigFileReader* m_configFile;
};

#endif /* SRC_HTTP_SVR_DBPOOL_H_ */
