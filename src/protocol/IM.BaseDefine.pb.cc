...
void protobuf_ShutdownFile_IM_2eBaseDefine_2eproto() {
  ...
  delete notifyInfo::default_instance_;
...
void protobuf_AddDesc_IM_2eBaseDefine_2eproto() {
  ...
  notifyInfo::default_instance_ = new notifyInfo();
  ...
  notifyInfo::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int notifyInfo::kIdFieldNumber;
const int notifyInfo::kSponerFieldNumber;
const int notifyInfo::kEmbrFieldNumber;
const int notifyInfo::kCreatetimeFieldNumber;
const int notifyInfo::kUpdatetimeFieldNumber;
const int notifyInfo::kStateFieldNumber;
const int notifyInfo::kUserinfoFieldNumber;
const int notifyInfo::kContentFieldNumber;
#endif  // !_MSC_VER

notifyInfo::notifyInfo()
  : ::google::protobuf::MessageLite() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:IM.BaseDefine.notifyInfo)
}

void notifyInfo::InitAsDefaultInstance() {
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  userinfo_ = const_cast< ::IM::BaseDefine::UserInfo*>(
      ::IM::BaseDefine::UserInfo::internal_default_instance());
#else
  userinfo_ = const_cast< ::IM::BaseDefine::UserInfo*>(&::IM::BaseDefine::UserInfo::default_instance());
#endif
}
...
notifyInfo::notifyInfo(const notifyInfo& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:IM.BaseDefine.notifyInfo)
}
...
notifyInfo::~notifyInfo() {
  // @@protoc_insertion_point(destructor:IM.BaseDefine.notifyInfo)
  SharedDtor();
}
...
notifyInfo* notifyInfo::default_instance_ = NULL;

notifyInfo* notifyInfo::New() const {
  return new notifyInfo;
}

void notifyInfo::Clear() {
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<notifyInfo*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
bool notifyInfo::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  ::google::protobuf::io::StringOutputStream unknown_fields_string(
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_string);
  // @@protoc_insertion_point(parse_start:IM.BaseDefine.notifyInfo)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_sponer;
        break;
      }
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_embr;
        break;
      }
        ...
        if (tag == 48) {
         parse_state:
          ...
          if (::IM::BaseDefine::AddFriendStatus_IsValid(value)) {
            set_state(static_cast< ::IM::BaseDefine::AddFriendStatus >(value));
          } else {
...
success:
  // @@protoc_insertion_point(parse_success:IM.BaseDefine.notifyInfo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:IM.BaseDefine.notifyInfo)
  return false;
#undef DO_
}

void notifyInfo::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:IM.BaseDefine.notifyInfo)
  // required uint32 id = 1;
  if (has_id()) {
  ...
  // required uint32 sponer = 2;
  if (has_sponer()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(2, this->sponer(), output);
  }

  // required uint32 embr = 3;
  if (has_embr()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(3, this->embr(), output);
  }
  ...
  output->WriteRaw(unknown_fields().data(),
                   unknown_fields().size());
  // @@protoc_insertion_point(serialize_end:IM.BaseDefine.notifyInfo)
}

int notifyInfo::ByteSize() const {
  int total_size = 0;
...
void notifyInfo::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const notifyInfo*>(&from));
}
...
void notifyInfo::MergeFrom(const notifyInfo& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_userinfo()) {
      mutable_userinfo()->::IM::BaseDefine::UserInfo::MergeFrom(from.userinfo());
    }
    if (from.has_content()) {
...
void notifyInfo::Swap(notifyInfo* other) {
  if (other != this) {
    std::swap(id_, other->id_);
    std::swap(sponer_, other->sponer_);
    std::swap(embr_, other->embr_);
...
::std::string notifyInfo::GetTypeName() const {
  return "IM.BaseDefine.notifyInfo";
}
