...
const int IMValidateReq::kIsregFieldNumber;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_isreg;
        break;
      }
...
void IMValidateReq::SerializeWithCachedSizes(
  ...
  // required uint32 isreg = 3;
  if (has_isreg()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(3, this->isreg(), output);
  }
...
const int IMValidateRsp::kIsregFieldNumber;
...
const int IMGetDeviceTokenReq::kPushTypeFieldNumber;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_push_type;
        break;
      }
        ...
        if (tag == 16) {
         parse_push_type:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::IM::BaseDefine::PushType_IsValid(value)) {
            set_push_type(static_cast< ::IM::BaseDefine::PushType >(value));
          } else {
